...
func CodecConv(c sel.Codec) ho.CodecName {
	switch c {
	case sel.CodecNull:
		return ho.Null
	case sel.CodecDeflate:
		return ho.Deflate
	case sel.CodecSnappy:
		return ho.Snappy
	case sel.CodecZstd:
		return ho.ZStandard
	default:
...
func ConfigToOpts(cfg sel.EncodeConfig) []ho.EncoderFunc {
...
func MapsToStdoutDefault(
	...
	return MapsToStdout(ctx, m, schema, sel.EncodeConfigDefault)
}
